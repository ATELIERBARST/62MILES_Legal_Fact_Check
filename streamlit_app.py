...
# Fetch the OpenAI API key from Streamlit Cloud secrets
...
if st.button("Analyze text"):
    if not document.strip():
        ...
        # Check for document length and warn if too large
        if len(document) > 5000:
            st.warning("The document exceeds 5000 characters. The analysis might be incomplete or inaccurate. Proceeding with the analysis anyway.")
        ...
        try:
            ...
            st.error(f"An error occurred with OpenAI: {str(e)}")
